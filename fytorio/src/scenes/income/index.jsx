...
import { dataIncome } from "../../data/data";
        ...
        <Grid container alignItems="center">
          ...
          <Grid item alignItems="right">
            <Button variant="contained" alignItems="center" fontSize="17px" startIcon={<AddCircleOutline />}
              onClick={() => addButtonClick("income")}>
              Add New
            </Button>
          </Grid>
        </Grid>
      </Box>
      <Card data={dataIncome} usePrefix="true" link="/income" />

      {openPopup === "income" && <IncomePopup open={true} includeDropdown="true" handleClose={handleClose} colors={colors} />}
    </Box>
  );
};
